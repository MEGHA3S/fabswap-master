...
Future<void> functionFetchUser() async {
  ...
  fetchLocalId();
  http.Response response = await http.get(Uri.parse('$urlBase$urlApi$urlConnector$urlRootUser'));
...
Future<void> functionUpdateCart(String cartId) async {
  ...
  http.Response response = await http.put(Uri.parse('$urlBase$urlApi$urlConnector$urlRootUser$urlConnector$myId'),body: {"cart":newCart});
  print(response.body);
  userModel= UserModel.fromJson(jsonDecode(response.body));
  print(response.body);
}
...
Future<void> functionStore(String name,String email , String password, context) async {
  ...
  http.Response response = await http.post(Uri.parse('$urlBase$urlApi$urlConnector$urlRootUser'),body: {'name':name,'email':email,'password':password});
...
Future<void> functionFetchFeed() async {
  print('inside function');
  http.Response response = await http.get(Uri.parse('$urlBase$urlApi$urlConnector$urlFeedUser'));
...
Future<void> functionStoreFeed(String userName,String img,String dressName,String dressSize,String dressPrice,String category,String userId,context) async {
  print('inside function');
  http.Response response = await http.post(Uri.parse('$urlBase$urlApi$urlConnector$urlFeedUser'),body: {'username':userName,'image':img,'dress_name':dressName,'dress_size':dressSize,'dress_price':dressPrice,'category':category,'userId':userId});
  feedModel= FeedModel.fromJson(jsonDecode(response.body));
